...
export const migrateWorld = async function () {
    ui.notifications.info(`Applying Year Zero Engine Coriolis System Migration for version ${game.system.data.version}. Please be patient and do not close your game or shut down your server.`, { permanent: true });
    ...
    ui.notifications.info(`Year Zero Engine Coriolis System Migration to version ${game.system.data.version} completed!`, { permanent: true });
};
